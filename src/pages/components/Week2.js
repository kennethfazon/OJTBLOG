...
import a from './week2/a.png';
import b from './week2/b.png';
import c from './week2/c.png';
import d from './week2/d.png';
  ...
  const programs = [
    {
      ...
      description: "During my second week at RHU, I quickly adapted to its fast-paced workflow, steadily enhancing my efficiency in tasks such as iClinicSys encoding and PhilHealth eligibility checks. I also came to appreciate the positive and welcoming environment, where the doctors, nurses, and staff were genuinely kind and supportive.",
      images: [
        a, b, c, d
      ],
    },
