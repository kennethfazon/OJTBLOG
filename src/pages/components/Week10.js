...
import a from './week10/a.png';
import b from './week10/b.png';
import c from './week10/c.png';
import d from './week10/d.png';
import e from './week10/e.png';
import o from './week10/o.png';
import p from './week10/p.png';
import q from './week10/q.png';
import r from './week10/r.png';
import m from './week10/m.jpg';
import n from './week10/n.jpg';
import s from './week10/s.jpg';
  ...
  const programs = [
    {
      ...
      description: "This week, we focused on developing the frontend of our website using Next.js and MUI (Material-UI) to create a fast, responsive, and visually appealing user interface. We started by setting up the project structure and integrating MUI’s ThemeProvider for a consistent design system. Our team implemented key UI components such as navigation bars, buttons, cards, and form inputs, ensuring a smooth user experience. We also optimized performance using Next.js’s server-side rendering (SSR) and static site generation (SSG), making our pages load faster. Additionally, we fine-tuned the styling with custom themes and dark mode support to enhance the overall look and feel. As we wrap up this phase, our focus will shift to improving interactivity and integrating API endpoints to bring the application to life.",
      images: [
        m, n, s, a, b, c, d, e, o, p, q, r
      ],
    },
  ];
