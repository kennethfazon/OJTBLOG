...
import a from './week6/a.png';
import b from './week6/b.png';
import c from './week6/c.png';
import d from './week6/d.png';
import e from './week6/e.png';
import f from './week6/f.png';
import g from './week6/g.png';
import h from './week6/h.png';
...
const Week6 = ({ open, onClose }) => {
  const [lightboxOpen, setLightboxOpen] = useState(false);
const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const programs = [
    {
      icon: <EarlyChildhoodIcon sx={style.icon} />,
      title: 'Guiding New JO Employees and Interns',
      description: "This week, I am assigned to guide and train the new Job Order (JO) employees and interns. My role includes introducing them to their tasks, familiarizing them with workplace processes, and ensuring they develop the necessary skills to perform efficiently. I will provide hands-on support, answer their questions, and help them adapt to the work environment smoothly.",
      images: [
        a, b, c, d, e, f, g, h
      ],
    },
