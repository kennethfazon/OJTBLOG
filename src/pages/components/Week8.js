...
import a from './week8/a.png';
import b from './week8/b.png';
import c from './week8/c.jpg';
import d from './week8/d.jpg';
import e from './week8/e.png';
import f from './week8/f.png';
import g from './week8/g.png';
import h from './week8/h.png';
...
const Week8 = ({ open, onClose }) => {
  const [lightboxOpen, setLightboxOpen] = useState(false);
const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const programs = [
    {
      icon: <EarlyChildhoodIcon sx={style.icon} />,
      title: 'PhilHealth Konsulta: Community Registration and Encoding',
      description: "This week, we successfully conducted the PhilHealth Konsulta Community Registration and Encoding initiative. During the activity, we assisted individuals in registering for the PhilHealth Konsultasyong Sulit at Tama (Konsulta) Program, ensuring they have access to essential healthcare services. Our team worked on encoding participant information into the system, verifying details, and guiding community members through the registration process. This initiative aims to expand healthcare accessibility and encourage more individuals to benefit from PhilHealth’s primary care services.",
      images: [
        a, b, c, d, e, f, g, h
      ],
    },
